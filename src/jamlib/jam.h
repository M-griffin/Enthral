...
//#ifndef linux
//typedef unsigned short uint16_t;   /* must be 16 bits wide */
//typedef unsigned long  uint32_t;    /* must be 32 bits wide */
//#endif

//typedef unsigned char  uint8_t;    /* must be  8 bits wide */
